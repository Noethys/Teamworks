...
import Saisie_Deplacement
import Saisie_Remboursement
...
class Panel(wx.Panel):
    def __init__(self, parent, id=-1, IDpersonne=0):
        ...
        self.bouton_deplacements_modifier = wx.BitmapButton(self, -1, wx.Bitmap("Images/16x16/Modifier.png", wx.BITMAP_TYPE_PNG))
        ...
        self.bouton_remboursements_modifier = wx.BitmapButton(self, -1, wx.Bitmap("Images/16x16/Modifier.png", wx.BITMAP_TYPE_PNG))
        self.bouton_remboursements_supprimer = wx.BitmapButton(self, -1, wx.Bitmap("Images/16x16/Supprimer.png", wx.BITMAP_TYPE_PNG))
...
##        grid_sizer_boutons_remboursements.Add(self.bouton_remboursements_imprimer, 0, 0, 0) 
    ...
    def AjouterDeplacement(self):
        dlg = Saisie_Deplacement.SaisieDeplacement(self, IDdeplacement=None, IDpersonne=self.IDpersonne)  
    ...
    def ModifierDeplacement(self):
        ...
        dlg = Saisie_Deplacement.SaisieDeplacement(self, IDdeplacement=IDdeplacement, IDpersonne=self.IDpersonne)  
        if dlg.ShowModal() == wx.ID_OK:
            self.ctrl_deplacements.MAJListeCtrl()
            self.ctrl_remboursements.MAJListeCtrl()
            dlg.Destroy()
    ...
    def OnBoutonImprimerDeplacement(self, event):
        ...
        import Impression_frais
        frm = Impression_frais.MyFrame(self, self.IDpersonne)
        frm.Show()
...
# ---------------------------------------------------
    ...
    def AjouterRemboursement(self):
        dlg = Saisie_Remboursement.SaisieRemboursement(self, IDremboursement=None, IDpersonne=self.IDpersonne)  
        if dlg.ShowModal() == wx.ID_OK:
            self.ctrl_deplacements.MAJListeCtrl()
            self.ctrl_remboursements.MAJListeCtrl()
            dlg.Destroy()
    ...
    def ModifierRemboursement(self):
        ...
        # Ouverture du formulaire de modification
        dlg = Saisie_Remboursement.SaisieRemboursement(self, IDremboursement=IDremboursement, IDpersonne=self.IDpersonne)  
        if dlg.ShowModal() == wx.ID_OK:
            self.ctrl_deplacements.MAJListeCtrl()
            self.ctrl_remboursements.MAJListeCtrl()
            dlg.Destroy()
