...
class Dialog(wx.Dialog):
    def __init__(self, parent, image=None, tailleCadre=(384, 384), titre=u"Editeur photo"):
        ...
        self.staticBox_decoration = wx.StaticBox(self, -1, u"Cadre de décoration")
        listeCadres = FonctionsPerso.GetListeCadresPhotos()
        self.combobox_decoration = wx.Choice(self, -1, choices=listeCadres)
        
        self.staticBox_texte_photo = wx.StaticBox(self, -1, u"Texte personnalisé")
