...
class ListView(FastObjectListView):
    def __init__(self, *args, **kwds):
        ...
        # Image list
        self.imgDirty = self.AddNamedImages("valide", wx.Bitmap("Images/16x16/Modifier.png", wx.BITMAP_TYPE_PNG))
    ...
    def Impression(self, mode="preview"):
        ...
        prt = UTILS_Printer.ObjectListViewPrinter(self, titre=_(_(u"Liste des traductions")), intro="", total="", format="A", orientation=wx.LANDSCAPE)
        if mode == "preview" :
            prt.Preview()
        else:
            prt.Print()
    ...
    def Modifier(self, event=None):
        ...
        import DLG_Saisie_texte_traduction
