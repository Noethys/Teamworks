    ...
    def Suite(self, etat):
        ...
        if etat == "trouvee" :
            ...
            if os.path.isfile(fichierAverifier) == True :
                ...
                texteNouveautes = "> Historique des mises à jour :\n\n" + self.texteNouveautes
...
class Page_installation(wx.Panel):
    ...
    def _Installation(self):
        ...
        if nomWindow == "general" : 
            # Si la frame 'General' est chargée, on sauvegarde et on ferme TeamWorks
            sleep(2)
            topWindow.Quitter()
            topWindow.Destroy()
        else:
            # Si il n'y a que le Updater qui est chargé, on quitte uniquement cette fenêtre
            sleep(2)
            self.parent.Fermer()
...
class MyFrame(wx.Frame):
    ...
    def __init__(self, parent):
        wx.Frame.__init__(self, parent, -1, title=_(u"Mises à jour Internet"), name="frm_updater", style=wx.DEFAULT_FRAME_STYLE)
        self.parent = parent
        self.page_active = ""
