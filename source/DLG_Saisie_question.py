...
class CTRL_Controle(wx.combo.BitmapComboBox):
    ...
    def MAJlisteDonnees(self):
        for dictControle in CTRL_Questionnaire.LISTE_CONTROLES :
            ...
            bmp = wx.Bitmap("Images/32x32/%s" % dictControle["image"], wx.BITMAP_TYPE_ANY)
...
class Dialog(wx.Dialog):
    def __init__(self, parent, type="individu", IDquestion=None):
        ...
        self.bouton_supprimer_choix = wx.BitmapButton(self, -1, wx.Bitmap(u"Images/16x16/Supprimer.png", wx.BITMAP_TYPE_ANY))
        self.bouton_monter_choix = wx.BitmapButton(self, -1, wx.Bitmap(u"Images/16x16/Fleche_haut.png", wx.BITMAP_TYPE_ANY))
