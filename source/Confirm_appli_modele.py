...
class Frm_confirm_appli(wx.Frame):
    ...
    def EnregistrementTaches(self, listeCreationsTaches) :
        ...
        self.bouton_ok.Hide()
        self.bouton_annuler.SetBitmapLabel(wx.Bitmap("Images/BoutonsImages/Arreter_L72.png", wx.BITMAP_TYPE_ANY))
        ...
        self.bouton_annuler.SetBitmapLabel(wx.Bitmap("Images/BoutonsImages/Ok_L72.png", wx.BITMAP_TYPE_ANY))     
...
class TreeCtrlTaches(wx.TreeCtrl):
    def __init__(self, parent):
        ...
        self.imgRacine = self.il.Add(wx.Bitmap("Images/16x16/Document.png", wx.BITMAP_TYPE_PNG))
        self.imgPersonne = self.il.Add(wx.Bitmap("Images/16x16/Homme.png", wx.BITMAP_TYPE_PNG))
        self.imgDate = self.il.Add(wx.Bitmap("Images/16x16/Calendrier_jour.png", wx.BITMAP_TYPE_PNG))
