...
class MyFrame(wx.Frame):
    def __init__(self, parent, title="Configuration du gadget Bloc-Notes"):
        ...
        # Police
        self.label_police = wx.StaticText(self.panel_base, -1, u"Police du texte :")
        ...
        # Apercu de la police
        self.label_apercu = wx.StaticText(self.panel_base, -1, u"Aperçu de la police :")
        self.label_exemplePolice = wx.StaticText(self.panel_base, -1, u" Exemple ", size=(-1, 30))
        self.MajExemplePolice()
        
        # Multipages
        self.label_multipages = wx.StaticText(self.panel_base, -1, u"Multi-pages :")
    ...
    def __set_properties(self):
        ...
        self.bouton_couleurPolice.SetToolTipString(u"Cliquez ici pour modifier la couleur de police du gadget")
        self.bouton_police.SetToolTipString(u"Cliquez ici pour modifier la police d'affichage")
        self.checkbox_multipages.SetToolTipString(u"Cochez cette case pour permettre la saisie de plusieurs pages de texte dans le bloc-notes")
