...
import platebtn # L'event ON ERASE BACKGROUND a été désactivé car il faisait planter l'affichage du fond du bouton sur wx 2.9.4
...
class MyFrame(wx.Dialog):
    def __init__(self, parent, checkAffichage=False, afficherDernierFichier=True, nomDernierFichier=""):
        ...
        for index, label, img, infobulle in self.listeCommandes :
            bouton = platebtn.PlateButton(self, index, label, img, style=bstyle)
