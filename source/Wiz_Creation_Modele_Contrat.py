...
from Wiz_Creation_Modele_Contrat_p1 import Page as Page1
from Wiz_Creation_Modele_Contrat_p2 import Page as Page2
from Wiz_Creation_Modele_Contrat_p3 import Page as Page3
...
class MyWizard(wx.Frame):
    ...
    def __set_properties(self):
        self.SetTitle(u"Création d'un modèle de contrat")
        _icon = wx.EmptyIcon()
