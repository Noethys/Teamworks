...
class Impression():
    def __init__(self, annee=2009, mois=12, listeIDpersonnes = [], dictPersonnes = {},
        ...
        # Paramètres du PDF
        nomDoc = "Temp/Impression_calendrier_mensuel.pdf"
        ...
        dataTableauTitre = [(u"Planning de %s %d" % (listeMois[self.mois-1], self.annee), u"Edité le %s" % dateDuJour ),]
...
##        self.dictPersonnes = ImportPersonnes(annee, mois)
        ...
        if nbre_legendes > 1 :
            ...
            legende = CaseLegende(0, 10, u"Total pour le mois", None, total_heures)
            dataTableauLegende[numLigne][numCol] = legende
...
class MyDialog(wx.Dialog):
    ...
    def __init__(self, parent, IDpersonne=None, annee=None, mois=None, autoriser_choix_personne=True):
        wx.Dialog.__init__(self, parent, id=-1, title=u"Edition d'un planning mensuel", size=(350, 300))
        ...
        self.label_nom = wx.StaticText(self, -1, u"Mois :")
    ...
    def __set_properties(self):
        ...
        self.ctrl_mois.SetToolTipString(u"Sélectionnez un mois de référence dans cette liste")
    ...
    def OnBoutonOk(self, event):
        ...
        if len(listeIDpersonnes) == 0 :
            dlg = wx.MessageDialog(self, u"Vous devez sélectionner au moins une personne présente durant ce mois !", u"Erreur de saisie", wx.OK | wx.ICON_EXCLAMATION)
            dlg.ShowModal()
            dlg.Destroy()
            return   
...
class MyChoice(wx.Choice):
    def __init__(self, parent):
        wx.Choice.__init__(self, parent, size=(-1, -1), choices=(u"Janvier", u"Février", u"Mars", u"Avril", u"Mai", u"Juin", u"Juillet", u"Août", u"Septembre", u"Octobre", u"Novembre", u"Décembre"))
        self.dictIndexes = {}
        self.Select(0)
