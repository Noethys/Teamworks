...
class Frm_SaisieModele(wx.Frame):
    ...
    def OnBoutonAjouter(self, event):
        ...
        frame_SaisiePresences = SaisiePresences.Frm_SaisiePresences(self, mode="modele")
    ...
    def OnBoutonModifier(self, event):
        ...
        frame_SaisiePresences = SaisiePresences.Frm_SaisiePresences(self, listeDonnees=listeDonnees, IDmodif=IDmodif, mode="modele")
        frame_SaisiePresences.Show()
        frame_SaisiePresences.panel.sizer_1.Hide(False)
        frame_SaisiePresences.panel.sizer_donnees_staticbox.Hide()
        frame_SaisiePresences.panel.grid_sizer_base.Layout()
