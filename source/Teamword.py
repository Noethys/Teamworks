...
REPERTOIRE_IMAGES = "Images/Teamword/"
IMAGES = {
    "nouveau" : "nouveau.png", 
    "ouvrir" : "ouvrir.png",
...
##        print self.rtc.GetBasicStyle()
        ...
        self.panelMail = Parametres_mail.Panel(self)
...
##        dlg.Destroy()
    ...
    def EcritTexteTest(self):
        ...
        self.rtc.Newline()
        img1 = wx.Bitmap("Images/Special/Logo_accueil.png", wx.BITMAP_TYPE_ANY)
