...
LISTE_CONTROLES = [
    {"code" : "ligne_texte", "label" : u"Ligne de texte", "image" : "Texte_ligne.png"},
    {"code" : "bloc_texte", "label" : u"Bloc de texte multiligne", "image" : "Texte_bloc.png", "options" : {"hauteur":60} },
    {"code" : "entier", "label" : u"Nombre entier", "image" : "Ctrl_nombre.png", "options" : {"min":0, "max":100} },
    {"code" : "liste_deroulante", "label" : u"Liste déroulante", "image" : "Ctrl_choice.png", "options":{"choix":None} },
    {"code" : "liste_coches", "label" : u"Liste à cocher", "image" : "Coches.png", "options" : {"hauteur":-1, "choix":None}},
    {"code" : "case_coche", "label" : u"Case à cocher", "image" : "Ctrl_coche.png"},
    {"code" : "date", "label" : u"Date", "image" : "jour.png"},
    {"code" : "slider", "label" : u"Réglette", "image" : "Reglette.png", "options" : {"hauteur":-1, "min":0, "max":100} },
    {"code" : "couleur", "label" : u"Couleur", "image" : "Ctrl_couleur.png", "options" : {"hauteur":20}},
##    {"code" : "potentiometre", "label" : u"Potentiomère", "image" : "Potentiometre.png", "options" : {"hauteur":100, "min":0, "max":100} },
    {"code" : "documents", "label" : u"Porte-documents", "image" : "Document.png", "options" : {"hauteur":60}},
    ] 
