...
class MyDialog(wx.Dialog):
    ...
    def __init__(self, parent, nom_filtre=u"", titre_frame = u"", selection=None, listeChoix = []):
        ...
        self.radio2 = wx.RadioButton(self, -1, u"Uniquement l'élément sélectionné :")
...
if __name__ == "__main__":
    ...
    frm = MyDialog(None, nom_filtre=u"les offres", titre_frame = u"Filtre des offres", selection=None, listeChoix = [(1, "offre 1"), (2, "offre 2")])
    frm.ShowModal()
    app.MainLoop()