...
import Scenario_select_categories
import Scenario_select_periode
import Scenario_saisie_prevision
import Scenario_saisie_report
...
class MyFrame(wx.Frame):
    ...
    def OnLeftLink(self, event):
        ...
        dlg = Scenario_select_categories.MyDialog(self, listeSelectionsDefaut, listeDisabledItems)  
    ...
    def OnBoutonImprimerTableau(self, event):
        ...
        nomDoc = "Temp/tableauScenarioTemp.pdf"
...
##        self.InitTableau()
    ...
    def CommandeSelectionPeriode(self, IDcategorie):
        ...
        dlg = Scenario_select_periode.MyDialog(self)
    ...
    def CommandeSaisiePrevision(self, IDcategorie):
        if self.dictVirtualDB.has_key(IDcategorie) :
            ...
            prevision = "+00:00"
        dlg = Scenario_saisie_prevision.MyDialog(self, prevision, self.parent.ctrl_modeHeure.GetSelection())
        if dlg.ShowModal() == wx.ID_OK:
    ...
    def CommandeSaisieReport(self, IDcategorie):
        if self.dictVirtualDB.has_key(IDcategorie) :
            ...
            report = None
        dlg = Scenario_saisie_report.MyDialog(self, self.IDscenario, self.parent.GetIDpersonne(), IDcategorie, report, self.parent.ctrl_modeHeure.GetSelection())
        if dlg.ShowModal() == wx.ID_OK:
