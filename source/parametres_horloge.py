...
class MyFrame(wx.Frame):
    def __init__(self, parent, title="Configuration du gadget Horloge"):
        ...
        self.label_couleurFace = wx.StaticText(self.panel_base, -1, u"Couleur de face :")
    ...
    def __set_properties(self):
        ...
        self.bouton_couleurFace.SetToolTipString(u"Cliquez ici pour modifier la couleur de face de l'horloge")
        self.bouton_couleurFond.SetToolTipString(u"Cliquez ici pour modifier la couleur de fond de l'horloge")
