...
class Panel(wx.Panel):
    def __init__(self, parent, ID=-1):
        ...
        self.barreTitre = FonctionsPerso.BarreTitre(self,  u"Les offres d'emploi", u"")
        texteIntro = u"Vous pouvez ici créer, modifier ou supprimer des offres d'emploi."
...
##        self.listCtrl.MAJListeCtrl()
    ...
    def Modifier(self):
        ...
        if len(listeDonnees) != 0 :
            dlg = wx.MessageDialog(self, u"Cette offre d'emploi a déjà été attribué à " + str(len(listeDonnees)) + u" candidature(s).\nEtes-vous sûr de vouloir la modifier ?", "Confirmation", wx.YES_NO|wx.NO_DEFAULT|wx.ICON_EXCLAMATION)
        ...
        frm = Saisie_Emploi.MyFrame(self, IDemploi=varID)
        frm.Show()
    ...
    def Supprimer(self):
        ...
        if index == -1:
            dlg = wx.MessageDialog(self, u"Vous devez d'abord sélectionner une offre d'emploi à supprimer dans la liste.", "Information", wx.OK | wx.ICON_INFORMATION)
            dlg.ShowModal()
            dlg.Destroy()
            return
...
class ListCtrl(wx.ListCtrl, listmix.ListCtrlAutoWidthMixin, listmix.ColumnSorterMixin):
    ...
    def Remplissage(self):
        ...
        self.InsertColumn(2, u"Détail")
        self.SetColumnWidth(2, 300)
        self.InsertColumn(3, u"Nb candidatures associées")
...
class MyFrame(wx.Frame):
    ...
    def __set_properties(self):
        self.SetTitle(u"Gestion des offres d'emploi")
        _icon = wx.EmptyIcon()
