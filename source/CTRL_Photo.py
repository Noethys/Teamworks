...
class CTRL_Photo(wx.StaticBitmap):
    ...
    def Menu_Imprimer(self, event):
        ...
        frame = Impression_photo.MyFrame(None, listePersonnes=[[self.IDindividu, donnees[1], donnees[2], None],])
        frame.Show()
