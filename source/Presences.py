...
##        sizer.Add(self.barreTitre, 0, wx.EXPAND|wx.TOP|wx.LEFT|wx.RIGHT, 10)
    ...
    def OnMotion_imgMenu(self, event):
        self.imgMenu.SetBitmap(wx.Bitmap("Images/16x16/MiniFleche_bas_rg.png", wx.BITMAP_TYPE_PNG))
        event.Skip()

    def OnLeaveWindow_imgMenu(self, event):
        self.imgMenu.SetBitmap(wx.Bitmap("Images/16x16/MiniFleche_bas_nr.png", wx.BITMAP_TYPE_PNG))
        event.Skip()
...
##        self.GetGrandParent().GetParent().MAJpanelPlanning()
    ...
    def Menu_70(self,event):
        ...
        frm_application = application_modele.frm_application_modele(self, selectionPersonnes=selectionPersonnes, selectionDates=selectionDates )
    ...
    def Menu_80(self,event):
        ...
        frm_liste = PagePresences.MyFrame(self, IDpersonne=IDpersonne)
        frm_liste.Show()
    ...
    def Menu_90(self,event):
        ...
        dlg = Impression_calendrier_annuel.MyDialog(None, IDpersonne=IDpersonne, autoriser_choix_personne=False)
        dlg.ShowModal()       
...
class PanelPresences(wx.Panel):
    ...
    def InitPage(self):
        ...
        self.panelPlanning = Planning.PanelPlanning(self.splitterV, -1)
...
##        self.panelPlanning.listePresents = self.panelPlanning.RecherchePresents(selectionDates)
##        self.MAJpanel()
        self.panelCalendrier.MAJselectionDates(listeDates=selectionDates)
##        self.MAJpanelPlanning()
...
##            evt.Veto()
    ...
    def MAJpanelPlanning(self, reinitSelectionPersonnes=False) :
        ...
        global selectionPersonnes, selectionDates
        modeAffichage = Planning.modeAffichage
