...
class ListView(ObjectListView):
    def __init__(self, *args, **kwds):
        ...
        # Texte
        self.imgVerrouillage = wx.StaticBitmap(self, -1, wx.Bitmap("Images/Special/Cadenas.png", wx.BITMAP_TYPE_ANY), pos=(2, self.GetSize()[1]+1-18))
...
##                listeListes.append(GetListeAffectations(dictFiltres))
    ...
    def InitObjectListView(self):            
        ...
        if self.modeAffichage != "gadget" :
            ...
            self.imgCadenas= imagelist.Add(wx.Bitmap("Images/22x22/Cadenas.png", wx.BITMAP_TYPE_PNG))
            self.imgAvis0= imagelist.Add(wx.Bitmap("Images/22x22/Smiley_question.png", wx.BITMAP_TYPE_PNG))
            self.imgAvis1= imagelist.Add(wx.Bitmap("Images/22x22/Smiley_nul.png", wx.BITMAP_TYPE_PNG))
            self.imgAvis2= imagelist.Add(wx.Bitmap("Images/22x22/Smiley_bof.png", wx.BITMAP_TYPE_PNG))
            self.imgAvis3= imagelist.Add(wx.Bitmap("Images/22x22/Smiley_bien.png", wx.BITMAP_TYPE_PNG))
            self.imgAvis4= imagelist.Add(wx.Bitmap("Images/22x22/Smiley_genial.png", wx.BITMAP_TYPE_PNG))
...
##        self.GetGrandParent().GetParent().OnBoutonAide(None)
    ...
    def Ajouter(self):
        ...
        frm = Saisie_Entretien.MyFrame(self, IDentretien=None, IDcandidat=IDcandidat, IDpersonne=IDpersonne)
        frm.Show()
    ...
    def Modifier(self):
        ...
        frm = Saisie_Entretien.MyFrame(self, IDentretien=IDentretien, IDcandidat=IDcandidat, IDpersonne=IDpersonne)
        frm.Show()
...
class Impression():
    def __init__(self, liste_labelsColonnes=[], listeValeurs=[], listeSelections=[]):
        ...
        nomDoc = "Temp/liste_entretiens.pdf"
