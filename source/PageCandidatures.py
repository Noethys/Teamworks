...
class Panel(wx.Panel):
    def __init__(self, parent, id=-1, IDpersonne=0):
        ...
        self.bouton_candidatures_ajouter = wx.BitmapButton(self, -1, wx.Bitmap("Images/16x16/Ajouter.png", wx.BITMAP_TYPE_PNG))
        ...
        self.bouton_entretiens_ajouter = wx.BitmapButton(self, -1, wx.Bitmap("Images/16x16/Ajouter.png", wx.BITMAP_TYPE_PNG))
        self.bouton_entretiens_modifier = wx.BitmapButton(self, -1, wx.Bitmap("Images/16x16/Modifier.png", wx.BITMAP_TYPE_PNG))
        self.bouton_entretiens_supprimer = wx.BitmapButton(self, -1, wx.Bitmap("Images/16x16/Supprimer.png", wx.BITMAP_TYPE_PNG))
