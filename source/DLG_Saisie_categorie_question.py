...
class Dialog(wx.Dialog):
    ...
    def __set_properties(self):
        self.SetTitle(u"Saisie d'une catégorie")
        self.ctrl_label.SetToolTipString(u"Saisissez ici un label")
        self.ctrl_couleur.SetToolTipString(u"Cliquez ici pour sélectionner la couleur de cette catégorie")
        self.ctrl_visible.SetToolTipString(u"Cochez cette case pour afficher cette catégorie")
