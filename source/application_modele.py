...
class Panel(wx.Panel):
    def __init__(self, parent, selectionLignes=[], selectionPersonnes=[], selectionDates=(None, None) ):
        ...
        self.bouton_ajouter = wx.BitmapButton(self.panel_base_2, -1, wx.Bitmap("Images/16x16/Ajouter.png", wx.BITMAP_TYPE_ANY))
        self.bouton_modifier = wx.BitmapButton(self.panel_base_2, -1, wx.Bitmap("Images/16x16/Modifier.png", wx.BITMAP_TYPE_ANY))
        self.bouton_dupliquer = wx.BitmapButton(self.panel_base_2, -1, wx.Bitmap("Images/16x16/Dupliquer.png", wx.BITMAP_TYPE_ANY))
        self.bouton_supprimer = wx.BitmapButton(self.panel_base_2, -1, wx.Bitmap("Images/16x16/Supprimer.png", wx.BITMAP_TYPE_ANY))
        self.bouton_aide = wx.BitmapButton(self.panel_base_2, -1, wx.Bitmap("Images/BoutonsImages/Aide_L72.png", wx.BITMAP_TYPE_ANY))
        self.bouton_ok = wx.BitmapButton(self.panel_base_2, -1, wx.Bitmap("Images/BoutonsImages/Ok_L72.png", wx.BITMAP_TYPE_ANY))
        self.bouton_annuler = wx.BitmapButton(self.panel_base_2, -1, wx.Bitmap("Images/BoutonsImages/Annuler_L72.png", wx.BITMAP_TYPE_ANY))
...
##            listeConfirmations.append(detailTache)
        ...
        #dictConfirmations = self.TriDict(dictConfirmations)
##        print dictConfirmations
##        print '-----------'
##        print listeCreationsTaches
        # Fenêtre de demande de confirmation
        frm_confirm = Confirm_appli_modele.Frm_confirm_appli(self, nbreTaches=nbreTaches, dictTaches=dictConfirmations, listeCreationsTaches=listeCreationsTaches, inclureFeries=inclureFeries)
        frm_confirm.Show()
...
##        return listeVacs2
    ...
    def OnBoutonAjouter(self, event):
        ...
        saisieModele = SaisieModele.Frm_SaisieModele(self, IDmodele=0)
        saisieModele.Show()
    ...
    def OnBoutonModifier(self, event):
        ...
        saisieModele = SaisieModele.Frm_SaisieModele(self, IDmodele=IDmodele)
        saisieModele.Show()
