...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        self.bouton_capture = wx.BitmapButton(self, -1, wx.Bitmap("Images/BoutonsImages/Capturer_photo.png", wx.BITMAP_TYPE_ANY))
    ...
    def OnBoutonCapture(self, event): 
        ...
        if self.ctrl_video.IsRunning() :
            ...
            CAMERA.saveSnapshot("Temp/capture_video.jpg", quality=100)
            self.bouton_capture.SetBitmapLabel(wx.Bitmap("Images/BoutonsImages/Capturer_photo2.png", wx.BITMAP_TYPE_ANY))
            self.bouton_ok.Enable(True)
        else:
            self.ctrl_video.StartVideo()
            self.bouton_capture.SetBitmapLabel(wx.Bitmap("Images/BoutonsImages/Capturer_photo.png", wx.BITMAP_TYPE_ANY))
            self.bouton_ok.Enable(False)
