...
class MyFrame(wx.Frame):
    ...
    def __set_properties(self):
        ...
        self.text_motCle.SetToolTipString(u"Saisissez ici un mot-clé qui sera utilisé pour le publipostage lors de l'impression des contrats. Ce mot-clé doit être unique, en majuscule et sans caractères spéciaux.")
