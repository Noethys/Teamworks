...
class DLG_Choix_action(wx.Dialog):
    def __init__(self, parent):
        ...
        self.bouton_enregistrer = CTRL_Bouton_image.CTRL(self, texte=_(u"Enregistrer sous"), cheminImage=Chemins.GetStaticPath("Images/48x48/Sauvegarder.png"), tailleImage=(48, 48), margesImage=(40, 20, 40, 0), positionImage=wx.TOP, margesTexte=(10, 10))
        self.bouton_enregistrer.SetToolTip(wx.ToolTip(_(u"Enregistrer le fichier Excel")))

        self.bouton_email = CTRL_Bouton_image.CTRL(self, texte=_(u"Envoyer par Email"), cheminImage=Chemins.GetStaticPath("Images/48x48/Email.png"), tailleImage=(48, 48), margesImage=(40, 20, 40, 0), positionImage=wx.TOP, margesTexte=(10, 10))
