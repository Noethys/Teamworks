...
class Sauvegarde_auto():
    ...
    def Importation(self):
        ...
        listeChamps = [
            ...
            "condition_derniere", "condition_utilisateur", "option_afficher_interface", "option_demander", "option_suppression", "option_confirmation",
            ]
        DB = GestionDB.DB()
        req = """SELECT %s
    ...
    def Sauvegarde(self, dictSauvegarde={}):
        ...
        inclure_modeles = dictSauvegarde["sauvegarde_modeles"]
        inclure_editions = dictSauvegarde["sauvegarde_editions"]
        ...
        # Sauvegarde
        resultat = UTILS_Sauvegarde.Sauvegarde(listeFichiersLocaux, listeFichiersReseau, nom, repertoire, motdepasse, listeEmails, dictConnexion, inclure_modeles, inclure_editions)
        if resultat == False :
            return False
        return True
