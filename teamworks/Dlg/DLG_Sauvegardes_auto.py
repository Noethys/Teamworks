...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        intro = _(u"Vous pouvez ici saisir, modifier ou supprimer des procédures de sauvegardes automatiques. Ces sauvegardes sont réalisées lors de la fermeture du fichier de données ou du logiciel en fonction des paramètres et conditions de votre choix.")
        titre = _(u"Sauvegardes automatiques")
        self.SetTitle(titre)
        self.ctrl_bandeau = CTRL_Bandeau.Bandeau(self, titre=titre, texte=intro, hauteurHtml=30, nomImage=Chemins.GetStaticPath("Images/32x32/Sauvegarde_param.png"))
        ...
        self.bouton_fermer = CTRL_Bouton_image.CTRL(self, id=wx.ID_CANCEL, texte=_(u"Fermer"), cheminImage=Chemins.GetStaticPath("Images/32x32/Fermer.png"))
