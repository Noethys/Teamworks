...
import datetime
from Dlg import DLG_Saisie_jour_ferie
...
class Panel_secondaire(wx.Panel):
    ...
    def __set_properties(self):
        self.bouton_ajouter.SetToolTip(wx.ToolTip(_(u"Cliquez ici pour créer un nouveau jour férié")))
        self.bouton_ajouter.SetSize(self.bouton_ajouter.GetBestSize())
        self.bouton_modifier.SetToolTip(wx.ToolTip(_(u"Cliquez ici pour modifier le jour férié sélectionné dans la liste")))
        self.bouton_modifier.SetSize(self.bouton_modifier.GetBestSize())
        self.bouton_supprimer.SetToolTip(wx.ToolTip(_(u"Cliquez ici pour supprimer le jour férié sélectionné dans la liste")))
...
##        grid_sizer_base.Add(sizer_legende, 0, 0, 0)
    ...
    def Supprimer(self):
        ...
        txtMessage = six.text_type((_(u"Voulez-vous vraiment supprimer ce jour férié ? \n\n> ") + Nom))
