...
##        self.label_conclusion = wx.StaticText(self, -1, "Remarques...")
    ...
    def __set_properties(self):
        self.bouton_ajouter.SetToolTip(wx.ToolTip(_(u"Cliquez ici pour créer un nouveau diffuseur")))
        self.bouton_ajouter.SetSize(self.bouton_ajouter.GetBestSize())
        self.bouton_modifier.SetToolTip(wx.ToolTip(_(u"Cliquez ici pour modifier le diffuseur sélectionné dans la liste")))
        self.bouton_modifier.SetSize(self.bouton_modifier.GetBestSize())
        self.bouton_supprimer.SetToolTip(wx.ToolTip(_(u"Cliquez ici pour supprimer le diffuseur sélectionné dans la liste")))
...
##        grid_sizer_base.Add(self.label_conclusion, 0, 0, 0)
    ...
    def Supprimer(self):
        ...
        txtMessage = six.text_type((_(u"Voulez-vous vraiment supprimer ce diffuseur ? \n\n> ") + Nom))
...
class Dialog(wx.Dialog):
    ...
    def __set_properties(self):
        self.SetTitle(_(u"Gestion des diffuseurs"))
