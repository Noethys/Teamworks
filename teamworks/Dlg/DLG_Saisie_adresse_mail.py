...
class MyDialog(wx.Dialog):
    ...
    def __set_properties(self):
        ...
        self.ctrl_ssl.SetToolTip(wx.ToolTip(_(u"Cliquez ici sur le serveur de messagerie utilise une connexion securisée SSL")))
    ...
    def Importation(self):
        ...
        if indexPredefini != None :
            ...
            if port != None :
                self.ctrl_port.SetValue(int(port))
            if ssl != None :
...
if __name__ == "__main__":
    ...
    dialog_1 = MyDialog(None, adresse=None)
    dialog_1.ShowModal()
    app.MainLoop()
