...
class Dialog(wx.Dialog):
    def __init__(self, parent, title="", nomBase="" ):
        ...
        self.ctrl_bandeau = CTRL_Bandeau.Bandeau(self, titre=titre, texte=intro, hauteurHtml=54, nomImage=Chemins.GetStaticPath("Images/32x32/Utilisateur_reseau.png"))
        self.SetTitle(titre)
        ...
        self.bouton_annuler = CTRL_Bouton_image.CTRL(self, id=wx.ID_CANCEL, texte=_(u"Fermer"), cheminImage=Chemins.GetStaticPath("Images/32x32/Fermer.png"))
